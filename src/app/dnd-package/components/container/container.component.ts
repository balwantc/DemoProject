...
export class ContainerComponent implements OnInit, AfterViewInit {
  ...
  @Output() changeStyle = new EventEmitter;
  ...
  getDestroyEvent(id) {
    ...
    let index = this.model.findIndex(data => data.userEditableProperties[0].propertyValue === id);
    this.model.splice(index, 1);
    this.changeStyle.emit('changeStyle');
  }
}
